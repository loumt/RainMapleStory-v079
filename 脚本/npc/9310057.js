...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "\t\t\t  #e#b米米冒险岛副本专区 #k#n\r\n"
            text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"
			
            text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"

            text += "#L1##b" + 红色箭头 + "月妙组队副本(10-200)#l \r\n"//3

            text += "#L2##b" + 蓝色箭头 + "废弃组队副本(15-200)  #r完成: " + (cm.getPlayer().getOneInfo(1201, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1201, "cmp")) + "次 #g#L31#扫荡\r\n"
            text += "#L3##b" + 蓝色箭头 + "玩具组队副本(35-200)  #r完成: " + (cm.getPlayer().getOneInfo(1202, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1202, "cmp")) + "次 #g#L32#扫荡#l\r\n"//3

            text += "#L4##b" + 红色箭头 + "天空组队副本(51-200)  #r完成: " + (cm.getPlayer().getOneInfo(1203, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1203, "cmp")) + "次 #g#L33#扫荡#l\r\n"
            text += "#L7##b" + 蓝色箭头 + "男女组队副本(71-200)  #r完成: " + (cm.getPlayer().getOneInfo(1205, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1205, "cmp")) + "次 #g#L34#扫荡#l\r\n"

            text += "#L5##b" + 红色箭头 + "毒物组队副本(85-200)  #r完成: " + (cm.getPlayer().getOneInfo(1206, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1206, "cmp")) + "次 #g#L35#扫荡#l\r\n"
           text += "#L6##b" + 蓝色箭头 + "海盗组队副本(105-200) #r完成: " + (cm.getPlayer().getOneInfo(1204, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1204, "cmp")) + "次 #g#L36#扫荡#l\r\n"

          //  text += "#L1##b" + 红色箭头 + "月妙组队副本(10-200)#l #L9##b" + 红色箭头 + "英语学院副本\r\n"//3
             
              // text += "#b#L21#" + 红色箭头 + "怪物公园副本(20-200)  #r完成: " + (cm.getPlayer().getOneInfo(1208, "cmp") == null ? "0" : cm.getPlayer().getOneInfo(1208, "cmp")) + "次#l\r\n"//3
           
          //  text += "#L10#"+xxx+""+ttt+ "怪物嘉年华(组队对抗副本.最低2V2)等级(30-100)#l\r\n"//3
         //   text += "#L8#"+ttt+""+xxx+ "遗址公会对抗战(家族副本)#l\r\n"//3
         //   text += "#L38##b" +红色箭头+"武陵道场\r\n"//3  
           text += "#L29##b" + 红色箭头 + "金字塔副本#l\r\n\r\n"//3
