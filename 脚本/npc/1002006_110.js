   ...
   status--;
	...
	text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        } else if(cm.haveItem(4021008,15) && cm.haveItem(4021001,15) && cm.haveItem(4021003,15) && cm.haveItem(4021007,15) && cm.haveItem(4000313,300) && cm.haveItem(1012412,1)){
