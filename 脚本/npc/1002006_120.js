   ...
   status--;
	...
	text += "     \r\n"
        cm.sendSimple(text);
            ...
            cm.dispose();
        } else if(cm.haveItem(4000313, 500) && cm.haveItem(4000152,50) && cm.haveItem(4000151,50) && cm.haveItem(4000407,50) && cm.haveItem(4000402,30) && cm.haveItem(4000406,30) && cm.haveItem(1012176,1)){
				cm.gainItem(40000313, -500);
...
cm.gainItem(1012057,30,30,30,30,5000,5000,10,10,0,0,0,0,0,0);
            cm.sendOk("换购成功！");
            cm.dispose();
