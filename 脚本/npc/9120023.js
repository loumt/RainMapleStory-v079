...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "想要#v1102163##r★贵族披风★#k\r\n需要以下物品：（普通属性，未来可通过觉醒提升）\r\n#v4000313##d#z4000313# * 10张\r\n#v4032226##d#z4032226# * 10只\r\n#v2140002##d金币 * 100W\r\n偷偷告诉你，枫之大陆上还有各种#r极品装备兑换商人#k哦，只要有材料就可以兑换，快去发现他们吧！~\r\n"
	text += "\r\n#L1##b我已集齐物品。确定兑换装备";
	text += "     \r\n"
        cm.sendSimple(text);
        } else if (selection == 1) {
            ...
            cm.dispose();
cm.喇叭(3, "玩家：[" + cm.getPlayer().getName() + "]★贵族披风★兑换成功，恭喜！！");
			}else{
