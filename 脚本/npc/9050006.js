var weapon = [1302070, 1472205, 1492170, 1402185, 1452196, 1362081, 1462184, 1322100, 1312142, 1332214, 1412126, 1422129, 1482159, 1372168, 1382199, 1442209, 1432158];
var req = [
    [4000313, 150],
    [4011001, 10],
    [4011000, 10],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendSimple("#d小子，所有#r布莱克武器#k都在我这里，看你够不够材料搞起了！\r\n\r\n必须亲自找到我才能兑换武器哦，我在#r自由市场#k！\r\n\r\n" + msg + "");
    } else if (status == 1) {
        sels = selection;
