 ...
 /*public static class pk extends 猜拳 {
    ...
    public static class online extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, new StringBuilder().append("当前").append(c.getChannel()).append("频道: ").append(channelOnline).append("人   ").append("当前伺服器总计线上人数: ").append(totalOnline).append("个").toString());
            return true;
        }
...
//        @Override
//        public String getMessage() {
//            return new StringBuilder().append("@jk - 重製").toString();
//        }
//    }
    ...
    public static class 出来吧皮卡丘 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            String npcname = GashaponFactory.getInstance().getGashaponByNpcId(mod).getName();
            final IItem item = MapleInventoryManipulator.addbyId_GachaponGM(c, id, (short) quantity);

            World.Broadcast.broadcastGashponmega(MaplePacketCreator.getGachaponMega(c.getPlayer().getName(), " : x" + quantity + "恭喜玩家 " + c.getPlayer().getName() + " 在" + npcname + "获得！", item, (byte) 1, c.getPlayer().getClient().getChannel()));
            return true;
        }
    ...
    /*public static class 匿名广播 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            World.Broadcast.broadcastSmega(MaplePacketCreator.SkullSmega(messages, false, c.getChannel()));
            FileoutputUtil.logToFile("logs/聊天/匿名广播.txt", "\r\n " + FileoutputUtil.NowTime() + " IP: " + c.getSession().remoteAddress().toString().split(":")[0] + " 消费类型 " + mod + " 玩家: " + c.getPlayer().getName() + " 说了 :" + msg);
            return true;
        }

        @Override
        public String getMessage() {
            return new StringBuilder().append("@匿名广播 - 具体用法 “@匿名广播 1/2 具体内容” 1为GASH，2为枫叶点数。").toString();
        }
    }*/
 ...
 /*public static class 查询玩家信息 extends CommandExecute {
            ...
            if (splitted.length < 2) {
                ...
                if (victim != null) {
                    if (victim.getGMLevel() > c.getPlayer().getGMLevel()) {
                        ...
                        c.getPlayer().dropMessage(5, "玩家名称: " + victim.getName() + " 上次一次维护后等级: " + victim.getCSDJ() + " 当前等级: " + victim.getLevel());
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("@").append(getClass().getSimpleName().toLowerCase()).append(" <玩家名字> - 查询玩家信息").toString();
        }
    }*/
 ...
 /*public static class 推荐人 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            byte reta;
            reta = MapleClient.setTGJF(c.getPlayer().getName(), c.getPlayer().getTGJF() + 1);
            if (reta == -2) {
            ...
            FileoutputUtil.logToFile("logs/Data/推荐人.txt", "\r\n " + FileoutputUtil.NowTime() + " 玩家 " + c.getPlayer().getName() + " 推荐人 " + name + " " + "1推广积分");
            FileoutputUtil.logToFile("logs/Data/推荐人.txt", "\r\n " + FileoutputUtil.NowTime() + " 玩家 " + name + " 被推荐人 " + c.getPlayer().getName() + " " + "1推广积分");
            return true;
        }
 ...
 /*public static class 告白广播 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            //World.Broadcast.broadcastSmega(MaplePacketCreator.SkullSmega(messages, false, c.getChannel()));
            World.Broadcast.broadcastSmega(MaplePacketCreator.HeartSmega(messages, false, c.getChannel()));
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("@告白广播 - 具体用法 “@告白广播 1/2 具体内容” 1为GASH，2为枫叶点数。如发表不当言论重者会遭管理员封锁，请自重。").toString();
        }
    }*/
    public static class 丢弃点装 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("@").append(getClass().getSimpleName().toLowerCase()).append("丢弃点装 [点装在装备栏的位置]").toString();
        }
    }
