...
public class GMCommand {
    ...
    public static class ShutdownTime extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            c.getPlayer().dropMessage(6, "伺服器将在 " + minutesLeft + "分钟后关闭. 请尽速关闭精灵商人 并下线.");
            ...
            if (ts == null && (t == null || !t.isAlive())) {
                ...
                c.getPlayer().dropMessage(6, new StringBuilder().append("伺服器关闭时间修改为 ").append(minutesLeft).append("分钟后，请稍等伺服器关闭").toString());
            }
            return true;
        }
    ...
    public static class copyAll extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!copyall 玩家名称 - 複製玩家").toString();
        }
    }
    ...
    public static class copyInv extends CommandExecute {
        ...
        public String getMessage() {
            return new StringBuilder().append("!copyinv 玩家名称 装备栏位(0 = 装备中 1=装备栏 2=消耗栏 3=其他栏 4=装饰栏 5=点数栏)(预设装备栏) - 複製玩家道具").toString();
        }
    }
...
//            }
    ...
    public static class 龙王地图重製 extends CommandExecute {
    ...
    public static class 枫币总量 extends CommandExecute {
